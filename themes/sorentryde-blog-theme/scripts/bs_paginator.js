...
function bsPaginatorHelper(options){
    ...
    var currentPage = '<li class="page-item active"><a class="page-link">' +
    ...
    if (prevNext){
        if (current > 1) {
            ...
            result += '<li class="page-item disabled"><a class="page-link">' + prevText + '</a></li>';
        }
    }
    ...
    if (options.show_all){
        ...
        var spaceHtml = '<li class="page-item disabled"><a class="page-space page-link">' + space + '</a></li>';
    ...
    if (prevNext){
        if (current < total) {
            ...
            result += '<li class="page-item disabled"><a class="page-link">' + nextText + '</a></li>';
        }
    }
